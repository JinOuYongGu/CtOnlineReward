...
public class SqlUtil {
    ...
    private final HikariDataSource sqlConnectionPool = CtOnlineReward.hikariCPBase.getSqlConnectionPool();
    ...
    public List<String> getTableList() {
        ...
        try {
            ...
            rs = md.getTables(null, config.getString("database.mysql_database"), null, null);
            while (rs.next()) {
